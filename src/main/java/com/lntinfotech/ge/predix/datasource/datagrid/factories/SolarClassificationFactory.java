 ...
 *
 */
public interface SolarClassificationFactory {
    ...
    //Solar classification filter
    List<SolarClassification> getClassificationsByFilterSolar(String uuid, String filter, String value, List<Header> headers);

    
    //For getting classification attributes
    List<SolarClassification> getAttributesByFilterSolar(String uuid, String filter, String value, List<Header> headers);
