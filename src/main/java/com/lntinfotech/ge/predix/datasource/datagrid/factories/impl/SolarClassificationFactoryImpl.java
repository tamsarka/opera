 ...
 *
 */
@Component(value = "solarClassificationFactory")
public class SolarClassificationFactoryImpl extends SolarFixtureFactory implements SolarClassificationFactory {

	private static final Logger log = LoggerFactory.getLogger(SolarClassificationFactoryImpl.class);
            ...
            List<Header> headers)
    {
        ...
        {
            log.error("Unexpected HTTP Response=" //$NON-NLS-1$
    ...
    //Solar classification filter Implementation
	@Override
	public List<SolarClassification> getClassificationsByFilterSolar(String uuid, String filter, String value,
			List<Header> headers) {

		CloseableHttpResponse response = null;
   	 	List<SolarClassification> list = null;
   	try { 
        response = get(SolarClassification.class, uuid, filter, value, headers);
       ...
       try
       {
           list = getObjectFromJson(SolarClassification.class, response);
       }
       catch (ParseException | IOException e)
       {
           throw new RuntimeException("uuid=" + uuid + " filter=" + filter + " " + e.getMessage(), e);
    ...
    //To get atttribues of classification
	public List<SolarClassification> getAttributesByFilterSolar(String uuid, String filter, String value,
			List<Header> headers) {

		CloseableHttpResponse response = null;
   	 	List<SolarClassification> list = null;
   	try { 
        response = getSolarAttributes(SolarClassification.class, uuid, filter, value, headers);
