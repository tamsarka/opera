package com.lntinfotech.ge.predix.datasource.common;
...
public class SolarRestMarshal {
	...
	protected void initPathMap() {
		...
		this.pathMap.put(SolarAsset.class, this.paths.asset);
		this.pathMap.put(SolarClassification.class, this.paths.classification);
	...
	private void initTypeReferenceMap() {
		...
		//For solar asset
		this.typeReferenceMap.put(SolarAsset.class,
				new TypeReference<List<SolarAsset>>() {
		    //
				});
		
		//For solar asset classification
		this.typeReferenceMap.put(SolarClassification.class,
				new TypeReference<List<SolarClassification>>() {
		    //
				});
	...
	public class Paths {
		...
		public final String solarAsset;
        ...
        Paths(String prefix) {
			...
			this.solarAsset=prefix+"/solarAsset";
		}
